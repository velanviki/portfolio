      ...
      <section id="project">
        ...
        <div class="project container " data-aos="fade-right">
          <div class="col-right">
            ...
            <ul className="tech_list">
              <li className="li_tech_list list_top">
                {" "}
                <i class="fas fa-angle-right left-arrow-heading"></i> JavaScript{" "}
              </li>
              <li className="li_tech_list">
                <i class="fas fa-angle-right left-arrow-heading"></i> Reactjs{" "}
              </li>
            </ul>
            <ul className="tech_list">
              <li className="li_tech_list list_top">
                {" "}
                <i class="fas fa-angle-right left-arrow-heading"></i> MongoDB{" "}
              </li>
              <li className="li_tech_list last_list_margin_bottom">
                <i class="fas fa-angle-right left-arrow-heading"></i> NodeJs{" "}
              </li>
            </ul>
            <a
              href="https://wishes-me.netlify.app/"
              class="cta"
              rel="noopener noreferrer"
              target="_blank"
            >
              <p class="fas fa-code-branch liveDemo_Icon"></p> Demo
            </a>
            <a
              href="https://github.com/velanviki/Wishes-project"
              class="cta"
              rel="noopener noreferrer"
              target="_blank"
            >
              <i class="fab fa-github github_Icon"></i> GitHub
            </a>
          </div>
          <div class="col-left">
          ...
          <div class="col-right">
            ...
            <a
              href="https://blog-me.netlify.app/"
              class="cta"
              rel="noopener noreferrer"
              target="_blank"
            >
            ...
            <a
              href="https://github.com/velanviki/blog-project"
              class="cta"
              rel="noopener noreferrer"
              target="_blank"
            >
          ...
          <div class="col-right">
            ...
            <a
              href="https://booksstores.netlify.app"
              class="cta"
              rel="noopener noreferrer"
              target="_blank"
            >
            ...
            <a
              href="https://github.com/velanviki/Book-project"
              class="cta"
              rel="noopener noreferrer"
              target="_blank"
            >
          ...
          <div class="col-left">
            <div class="project-img" data-aos="fade-in">
              <img
                src="https://www.uplist.lk/wp-content/uploads/2019/02/Bookshop-in-sri-lanka-1024x683.jpg"
                alt="img"
              />
            </div>
          </div>
          ...
          <div class="col-right">
            ...
            <a
              href="https://e-commerce-my.netlify.app/"
              class="cta"
              rel="noopener noreferrer"
              target="_blank"
            >
            ...
            <a
              href="https://github.com/velanviki/Ecommerce-project`"
              class="cta"
              rel="noopener noreferrer"
              target="_blank"
            >
