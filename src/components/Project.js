        ...
        <>
          ...
          <div class="project container " data-aos="fade-right">
            <div class="col-right">
                    ...
                    <a href="https://chic-klepon-4daa30.netlify.app" class="cta" rel="noopener noreferrer" target="_blank"><p class="fas fa-code-branch liveDemo_Icon"></p> Demo</a>
                    <a href="https://github.com/velanviki" class="cta" rel="noopener noreferrer" target="_blank"><i class="fab fa-github github_Icon"></i> GitHub</a>
                </div>
              <div class="col-left">
